package ai.runapi.gptimage2.resources;
...
public final class EditImageResource extends Gptimage2Resource {
  /** API endpoint path for edit image operations. */
  public static final String ENDPOINT = "/api/v1/gpt_image_2/edit_image";
